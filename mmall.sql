...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mmall` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `order_detail`(`id`,`order_id`,`product_id`,`quantity`,`cost`) values (115,133,735,4,608),(116,133,745,3,1767),(117,134,738,10,450),(118,134,739,66,10296),(119,134,758,10,5960),(120,134,735,33,5016),(121,134,740,6,948),(122,134,750,100,56900);
